...
bcftools view \
  -r chr13,chr17 \
  -Oz -o results/HCC1395_chr13_17.vcf.gz \
  /project2/msalomon_1816/trgn_515/3_annotation/HCC1395_breast_cancer/vcf/high-confidence_sSNV_in_HC_regions_v1.2.1.vcf.gz

bcftools annotate \
  -a gnomAD/gnomad.exomes.v4.1.sites.chr13.vcf.bgz \
  -c ID,INFO/AF \
  -Oz -o results/HCC1395_gnomad.vcf.gz \
  results/HCC1395_chr13_17.vcf.gz


bcftools annotate \
  -a clinvar/clinvar.vcf.gz \
  -c INFO/CLNSIG \
  -Oz -o results/HCC1395_clinvar.vcf.gz \
  results/HCC1395_gnomad.vcf.gz

tabix -p vcf HCC1395_clinvar.vcf.gz


tabix -p vcf HCC1395_gnomad.vcf.gz


# Use bcftools view to filter for variants with an AF < 1% (or absent entirely) 
# AND that have a Pathogenic or Likely_pathogenic ClinVar tag.
bcftools view \
  -i '(INFO/AF < 0.01 || INFO/AF=".") && (INFO/CLNSIG~"Pathogenic" || INFO/CLNSIG~"Likely_pathogenic")' \
  HCC1395_clinvar.vcf.gz
