...
::: {.callout-warning}
If a variant in your VCF is a somatic cancer mutation (meaning it only exists in the tumor and not in healthy humans), gnomAD will not have a record of it. In this case, bcftools will simply leave the AF tag blank (represented by a .).
:::
