...
1. Hard-filter the variants from your multi-sample VCF that fall within the hypervariable regions in the .bed file. Attach your command **(5pts)**
:::
...
gff_file=/project2/msalomon_1816/trgn_515/3_annotation/m_tuberculosis/reference/Mycobacterium_tuberculosis_h37rv.ASM19595v2.37.gff3
```
